                    ...
                    <aside class="top_nav" style="margin-top:0px !important">
                        <ul id="icons">
                            <?php if(is_null(Yii::app()->user->id) || empty(Yii::app()->user->id)) {?>
                                <li class="group-2"><a class="make-underline text-size" style="color:#428BCA;font-weight: bold" href="<?php echo Yii::app()->params['vmsAddress'].'/index.php/preregistration/login'; ?>">Login to AVMS</a></li>
