                        ...
                        <table style="margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
                            ...
                            <tr><td>
                                    ...
                                    <table id="passwordInputsTable">
                                        ...
                                        <tr>
                                            <td>
                                                <input placeholder="Password" type="password" class="original-password" id="Visitor_password" name="Visitor[password]">
                                        ...
                                        <tr>
                                            <td >
                                                <input  placeholder="Repeat Password"  type="password" id="Visitor_repeatpassword"  name="Visitor[repeatpassword]"/>
                                                <span class="required">*</span>
