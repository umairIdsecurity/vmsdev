...
<div class="page-content">
    ...
    <span><h3 class="text-primary" style="font-size: 15px;margin-bottom: -18px;">Please provide one identification from each of the following categories. You may also upload your documentation which will save time in the processing of your application.</h3></span><br>
    ...
    ?>
        ...
        <div class="row" id="new_asic_area">
			...
			<span>Birth Certificate, Valid Passport, Citizenship Certificate, Certificate or Resident Status<span></br>
			...
			<span>Only required if Category A, B and C do not include your current residential address</span></br>
                ...
                <div class="row form-group">
                    <div class="col-xs-12 col-md-12 col-sm-12">
                        ...
                        ?>
                        <?php echo $form->error($model, 'tertiary_id1_expiry'); ?>
                    </div>
                </div>
				<div class="row form-group">
                    <div class="col-xs-12 col-md-12 col-sm-12">
