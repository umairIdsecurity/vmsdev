...
$('body').on('click','input[type="checkbox"]', function(){
         //alert('yes');
			if($(this).is(':checked'))
			{
				$.ajax({
                type: 'POST',
                url: 'http://vmsdev-win.identitysecurity.info/index.php?r=asicApplicant/isCompleted',
                data: 'id='+$(this).val(),
       ...
       else
			{
				$.ajax({
                type: 'POST',
                url: 'http://vmsdev-win.identitysecurity.info/index.php?r=asicApplicant/makeIncompleted',
                data: 'id='+$(this).val(),
                success: function (data) {
...
EOJ;
	...
	Yii::app()->clientScript->registerScript('checking',$js);
	//Yii::app()->clientScript->registerScript('checkbox',"");
/* @var $this VisitController */
/* @var $model Visit */
?>

<h1>ASIC Applicants</h1>
<?php echo CHtml::button('Export to Auscheck Template',array('id' => 'export-button', 'class' => 'greenBtn complete','submit'=>array('asicApplicant/exportAuscheck')));?>
</br>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'         => array(
		...
		array(
                ...
                'selectableRows' => '100',
				'headerTemplate'=>'<span style="font-size:12px;">Ready To Lodge</span>',
