...
class DX_Mailer
{
    ...
    /**
     * Path to DX_Mailer plugins.  This is now only useful if the SMTP class 
    ...
    */
    ...
    function Send() 
    {
        ...
        switch($this->Mailer) {
            ...
            default:
            	$this->SetError("mailer_not_supported");
                $result = false;
                break;
        }
    ...
    function CreateHeader() 
    {
        ...
        $result .= $this->HeaderLine("X-Mailer", "DX_Mailer [version " . $this->Version . "]");
