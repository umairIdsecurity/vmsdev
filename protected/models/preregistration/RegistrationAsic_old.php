...
class RegistrationAsic extends CActiveRecord {
	...
	public function rules()
	{
		...
		return array(
			...
			//array('from_date', 'type', 'type' => 'date', 'message' => '{attribute}: is not in dd/mm/yyyy form', 'dateFormat' => 'dd/MM/yyyy'),
		...
		if(Yii::app()->controller->action->id=='identificationAsicOnline')
		{
			...
			return array(	
			array('primary_id,primary_id_no, country_id1, primary_id_expiry,secondary_id,secondary_id_no,secondary_id_expiry,country_id2,country_id3,tertiary_id2,tertiary_id2_expiry', 'required' , 'message'=>'Please enter {attribute}'),
			array('country_id4,tertiary_id1','ext.validator.IdentificationCustom'),
			array('given_name2 , given_name3 , home_phone , mobile_phone , work_phone , condition_of_use , aus_check , application_type , unit , city , created_on , employment_status , company_id , upload_1 , upload_2 , upload_3 , operational_need , tenant , postal_unit , postal_street_number , postal_street_name , postal_street_type , postal_suburb , postal_postcode , postal_city , postal_state , postal_country,upload_4,tertiary_id1_no,tertiary_id2_no,tertiary_id2_expiry,tertiary_id1_expiry','safe' ),
    ...
    public function attributeLabels()
    {
        return array(
			...
			'tertiary_id2_expiry'						=> 'Expiry date (if applicable)',
			...
			'primary_id_expiry'							=>'Category A Expiry',
			'secondary_id_expiry'						=>'Category B Expiry',
			'tertiary_id2_expiry'						=>'Category C Expiry',
        );
    }
