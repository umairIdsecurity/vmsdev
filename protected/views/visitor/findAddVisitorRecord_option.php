...
<script>
    ...
    function afterValidate(form, data, hasError) {
        ...
        if (!hasError){
            if($('#VisitCardType').val() > CONTRACTOR_TYPE && $("#Visitor_password_requirement_1").is(":checked") == true ) {
                ...
                else if($(".password_option").is(":checked")== true && $(".password_option:checked").val()==1 && ($("#Visitor_password_input").val()== "" || $("#Visitor_repeatpassword_input").val()=="")){
                    $(parentElement()+"#pass_error_").show();
                    $(parentElement()+"#pass_error_").html("Type password or generate");
                    return false;
                }
                else if($(".password_option").is(":checked")== true && $(".password_option:checked").val()==1 && $("#Visitor_password_input").val() != "" && $("#Visitor_repeatpassword_input").val() !="" && $("#Visitor_repeatpassword_input").val() != $("#Visitor_password_input").val()){
                    $(parentElement()+"#pass_error_").show();
