...
(function(b) {
    if (b.fn.ajaxForm == undefined) {
        b.getScript("assets/609356e1/js/jquery.form.js")
    }
    var a = {};
    ...
    b.fn.uploadFile = function(f) {
        var p = b.extend({url: "", method: "POST", enctype: "multipart/form-data", returnType: null, allowDuplicates: true, duplicateStrict: false, allowedTypes: "*", acceptFiles: "*", fileName: "file", formData: {}, dynamicFormData: function() {
            ...
            }, downloadCallback: false, deleteCallback: false, afterUploadAll: false, abortButtonClass: "ajax-file-upload-abort", cancelButtonClass: "ajax-file-upload-cancel", dragDropContainerClass: "ajax-upload-dragdrop", dragDropHoverClass: "state-hover", errorClass: "ajax-file-upload-error", uploadButtonClass: "actionForward ajax-file-upload btn btn-info", dragDropStr: "<div class='uploadnotetext'><b>Drag &amp; Drop File</b><br><span style='font-size:10px;'>Max Size: 2MB ;File Ext. : jpeg/png<br><span class='imageDimensions'>Dimensions: 180px(Width) x 60px(Height)</span></div>", abortStr: "Abort", cancelStr: "Cancel", deletelStr: "Delete", doneStr: "Done", multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.", extErrorStr: "Image is not allowed. Allowed extensions: ", duplicateErrorStr: "is not allowed. File already exists.", sizeErrorStr: "is not allowed. Allowed Max size: ", uploadErrorStr: "Upload is not allowed", maxFileCountErrorStr: " is not allowed. Maximum allowed files are:", downloadStr: "Download", customErrorKeyStr: "jquery-upload-file-error", showQueueDiv: false, statusBarWidth: 100, dragdropWidth: 200, showPreview: false, previewHeight: "auto", previewWidth: "100%", uploadFolder: "uploads/"}, f);
        this.fileCounter = 1;
        ...
        function r(K, E, x) {
            for (var F = 0; F < x.length; F++) {
                if (!g(E, K, x[F].name)) {
                    if (K.showError) {
                        b("<div class='" + K.errorClass + "'>" + K.extErrorStr + K.allowedTypes + "</div>").appendTo(E.errorLog)
                    }
                    continue
                }
        ...
        function k(D, C, z, x) {
            ...
            A.change(function() {
                ...
                if (this.files) {
                    ...
                    if (!g(D, z, J)) {
                        if (z.showError) {
                            b("<div class='" + z.errorClass + "'>" + z.extErrorStr + z.allowedTypes + "</div>").appendTo(D.errorLog)
                        }
                        return
                    }
