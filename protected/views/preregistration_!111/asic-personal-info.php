...
<div class="page-content">
    ...
    <a href="<?php echo Yii::app()->createUrl('preregistration/personalAsicOnline'); ?>"><h3 class="text-primary subheading-size">Personal Details</h3></a>
			...
			$('#AsicAddressHistory_to_date_container').val('');
				...
				if(total>=3650)
				{
					...
					$.alert({
						...
						content: 'If you have filled all forms please proceed to the next page',
					});
				}
		}
		else
