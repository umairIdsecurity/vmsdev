...
class Issue7FunctionalTest extends BaseFunctionalTest {
    ...
    function Scenario3() {
        $username = 'superadmin@test.com';
        $this->login($username, '12345');
        $this->open("http://localhost/vms/index.php?r=user/profile&id=17");
        $this->assertEquals("You are not authorized to perform this action.", $this->getText("css=div.error"));
        $this->open("http://localhost/vms/index.php?r=user/profile&id=18");
        $this->assertEquals("You are not authorized to perform this action.", $this->getText("css=div.error"));
        $this->open("http://localhost/vms/index.php?r=user/profile&id=19");
        $this->assertEquals("You are not authorized to perform this action.", $this->getText("css=div.error"));
        $this->open("http://localhost/vms/index.php?r=user/profile&id=20");
        $this->assertEquals("You are not authorized to perform this action.", $this->getText("css=div.error"));
        $this->open("http://localhost/vms/index.php?r=user/profile&id=21");
        $this->assertEquals("You are not authorized to perform this action.", $this->getText("css=div.error"));
    }
