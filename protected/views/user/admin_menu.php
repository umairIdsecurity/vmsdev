    ...
    <div id='cssmenu'>
        <ul>
            ...
            <li class='has-sub'>
                ...
                ?>
                <ul <?php
                if ($this->action->id == 'vicTotalVisitCount' || $this->action->id == 'vicRegister' || $this->action->id == 'totalVicsByWorkstation' || $this->action->id == 'profilesAvmsVisitors' || $this->action->id == 'visitorsVicByType') {
                    echo "style='display:block ;'";
                }
                ?>>
