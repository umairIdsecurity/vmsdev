...
if ($this->action->id == 'inducteeUpdate') {
	$dataId = $_GET['id'];
}
/*$currentRoleinUrl = '';
if (isset($_GET['role'])) {
			...
			<tr>
				<td class="columns-induction-section">
					<table class="upload-photo-table">
								...
								<div class="cardPhotoPreview">
									<input type="hidden" id="Visitor_photo" name="Visitor[photo]"
										...
										.ajax-upload-dragdrop {
											...
											background-size: 155px 204px !important;
						...
						<tr>
							<td>
								<button class="btn btn-info printCardBtn dropdown-toggle actionForward" type="button" id="menu1">
								...
								<tr>
									<td>
										<div class="personal-details-section">
											...
											<div class="visitor-input-text">
												<div class="personal-details-input required">
													<?php echo $form->dropDownList($visitor, 'contact_country', $countryList, array('empty' => 'Country')); ?>
													<?php //echo $form->dropDownList($visitor, 'contact_state', Visitor::$AUSTRALIAN_STATES, array('empty' => 'State')); ?>
												</div>
			...
			<div class="induction-section-column">
				<div class="induction-icon-section">
					<div class="induction-records-title">
						<h4 class="induction-title induction-records">Induction Records</h4> 
							<div class = "row asic-holder border-line">
								...
								<div class = "asic-holder asic_holder_label">
									<?php echo $form->labelEx($visitor, 'ASIC', array('class' => 'asic-holder-title')); ?>
									<?php echo $form->labelEx($visitor, 'Holder :', array('class' => 'asic-holder-title-1')); ?>
				...
				<div class="all-inductions">					
														...
														<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
															<tr>
																<td>
																	<div style="display:inline-block;">
																		<?php echo $form->labelEx($airSide, 'is_required_induction', array('class' => 'required-title')); ?>
																		<div class="switch switch-blue">
																			...
																			<input type="radio" class="switch-input is_required_induction_radio airside_safety" name="required_induction_airside_safety" value="1" id="month_airside_safety" <?php if (!empty($airSide->is_required_induction) && ($airSide->is_required_induction == "1")) {echo 'checked';} ?>>
																...
																<td>
																	<div class = "row">
																		<div class = "induction-required">
																			<?php echo $form->labelEx($airSide, 'is_completed_induction', array('class' => 'completed-expiry-title')); ?>
																		</div>
												
																		<div class = "compactRadioGroup radioBtnlist_airside_safety airside-safety-checkbox">
																			<?php echo $form->radioButtonList($airSide, '[1]is_completed_induction', array(0 => "No", 1 => "Yes"), array('separator' => " ")); ?>
																		</div>
																	</div>
																</td>
															</tr>
															...
															<tr class = "induction-expiry-row expiry_airside_safety">
																<td>
																	<div class = "row">
																		<div class = "induction-required">
																			<?php echo $form->labelEx($airSide, 'expiry', array('class' => 'completed-expiry-title')); ?>
																		</div>
												...
												<td>
													<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
														<tr>
															<td>
																<div style="display:inline-block;">
																	<?php echo $form->labelEx($Orientation, 'is_required_induction', array('class' => 'required-title Orientation_section')); ?>
																	<div class="switch switch-blue">
																		...
																		<input type="radio" class="switch-input is_required_induction_radio orientation" name="required_induction_orientation" value="1" id="month_orientation" <?php if (!empty($Orientation->is_required_induction) && ($Orientation->is_required_induction == "1")) {echo 'checked';} ?>>
														...
														<tr class = "induction-completed-row completed_orientation">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Orientation, 'is_completed_induction', array('class' => 'completed-expiry-title')); ?>
																	</div>
												
																	<div class = "compactRadioGroup radioBtnlist_orientation completed_date_orientation">
																		<?php echo $form->radioButtonList($Orientation, '[2]is_completed_induction', array(0 => "No", 1 => "Yes"), array('separator' => " ")); ?>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr class = "induction-expiry-row expiry_orientation">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Orientation, 'expiry', array('class' => 'completed-expiry-title')); ?>
																	</div>
												...
												<td>
													<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
														<tr>
															<td>
																<div style="display:inline-block;">
																	<?php echo $form->labelEx($Security, 'is_required_induction', array('class' => 'required-title security_section')); ?>
																	<div class="switch switch-blue">
																		...
																		<input type="radio" class="switch-input is_required_induction_radio security" name="required_induction_security" value="1" id="month_security" <?php if (!empty($Security->is_required_induction) && ($Security->is_required_induction == "1")) {echo 'checked';} ?>>
														...
														<tr class = "induction-completed-row completed_security">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Security, 'is_completed_induction', array('class' => 'completed-expiry-title')); ?>
																	</div>
													
																	<div class = "compactRadioGroup radioBtnlist_security completed_security">
																		<?php echo $form->radioButtonList($Security, '[3]is_completed_induction', array(0 => "No", 1 => "Yes"), array('separator' => " ")); ?>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr class = "induction-expiry-row expiry_security">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Security, 'expiry', array('class' => 'completed-expiry-title')); ?>
																	</div>
												...
												<td>
													<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
														<tr>
															<td>
																<div style="display:inline-block;">
																	<?php echo $form->labelEx($Safe, 'is_required_induction', array('class' => 'required-title sms_section')); ?>
																	<div class="switch switch-blue">
																		...
																		<input type="radio" class="switch-input is_required_induction_radio staying_safe" name="required_induction_staying_safe" value="1" id="month_staying_safe" <?php if (!empty($Safe->is_required_induction) && ($Safe->is_required_induction == "1")) {echo 'checked';} ?>>
														...
														<tr class = "induction-completed-row completed_staying_safe">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Safe, 'is_completed_induction', array('class' => 'completed-expiry-title')); ?>
																	</div>
													
																	<div class = "compactRadioGroup radioBtnlist_staying_safe completed_sms">
																		<?php echo $form->radioButtonList($Safe, '[4]is_completed_induction', array(0 => "No", 1 => "Yes"), array('separator' => " ")); ?>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr class = "induction-expiry-row expiry_staying_safe">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Safe, 'expiry', array('class' => 'completed-expiry-title')); ?>
																	</div>
												...
												<td>
													<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
														<tr>
															<td>
																<div style="display:inline-block;">
																	<?php echo $form->labelEx($Driving, 'is_required_induction', array('class' => 'required-title')); ?>
																	<div class="switch switch-blue">
																		...
																		<input type="radio" class="switch-input is_required_induction_radio airside_driving" name="required_induction_airside_driving" value="1" id="month_airside_driving" <?php if (!empty($Driving->is_required_induction) && ($Driving->is_required_induction == "1")) {echo 'checked';} ?>>
														...
														<tr class = "induction-completed-row completed_airside_driving">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Driving, 'is_completed_induction', array('class' => 'completed-expiry-title')); ?>
																	</div>
													
																	<div class = "compactRadioGroup completed_ADA">
																		<?php echo $form->radioButtonList($Driving, '[5]is_completed_induction', array(0 => "No", 1 => "Yes"), array('separator' => " ")); ?>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr class = "induction-expiry-row expiry_airside_driving">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Driving, 'expiry', array('class' => 'completed-expiry-title')); ?>
																	</div>
											...
											<td>
												<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
													<tr>
														<td>
															<div style="display:inline-block;"> 
																<?php echo $form->labelEx($Drug, 'is_required_induction', array('class' => 'required-title')); ?>
																<div class="switch switch-blue">
																	...
																	<input type="radio" class="switch-input is_required_induction_radio drug_and_alcohol" name="required_induction_drug_and_alcohol" value="1" id="month_drug_and_alcohol" <?php if (!empty($Drug->is_required_induction) && ($Drug->is_required_induction == "1")) {echo 'checked';} ?>>
													...
													<tr class = "induction-completed-row completed_drug_and_alcohol">
														<td>
															<div class = "row">
																<div class = "induction-required">
																	<?php echo $form->labelEx($Drug, 'is_completed_induction', array('class' => 'completed-expiry-title')); ?>
																</div>
												
																<div class = "compactRadioGroup radioBtnlist_drug_and_alcohol completed_DAMP">
																	<?php echo $form->radioButtonList($Drug, '[6]is_completed_induction', array(0 => "No", 1 => "Yes"), array('separator' => " ")); ?>
																</div>
															</div>
														</td>
													</tr>
													...
													<tr class = "induction-expiry-row expiry_drug_and_alcohol">
														<td>
															<div class = "row">
																<div class = "induction-required">
																	<?php echo $form->labelEx($Drug, 'expiry', array('class' => 'completed-expiry-title')); ?>
																</div>
				 ...
				 <div>
                    <?php echo CHtml::tag('button', array('type' => 'submit','class' => 'btn btn-primary btn-next induction-edit-submit'), 'submit <span class="glyphicon glyphicon-chevron-right"></span> ');?>
        		</div>	
			</div>				
...
<script>   
	...
	function findNearestDate(){
		console.log('date', '<?php echo $airSide->expiry ?>');
		var min = new Date('3000-12-12'); 
		var airSide = new Date('<?php echo $airSide->expiry ?>');
		var orientation = new Date('<?php echo $Orientation->expiry ?>');
		var security = new Date('<?php echo $Security->expiry ?>');
		var safe = new Date('<?php echo $Safe->expiry ?>');
		var driving = new Date('<?php echo $Driving->expiry ?>');
		var drug = new Date('<?php echo $Drug->expiry ?>');
		
		console.log(airSide);
		
		var dates = [airSide, orientation, security, safe, driving, airSide]; 
		var i;
	...
	$(document).ready(function(){
		if(<?php  if (!empty($airSide->induction_flag) && $airSide->induction_flag==1) echo 1; else echo 0;  ?>==1 || <?php if (!empty($Orientation->induction_flag) && $Orientation->induction_flag==1) echo 1; else echo 0; ?>==1 || <?php if (!empty($Security->induction_flag) && $Security->induction_flag==1) echo 1; else echo 0; ?>==1 || <?php if (!empty($Safe->induction_flag) && $Safe->induction_flag==1) echo 1; else echo 0; ?>==1 )
		{
			//$("#air").prop('checked',true);
			$('.induction-1').trigger('click');
			
		}
		if(<?php if (!empty($Driving->induction_flag) && $Driving->induction_flag==1) echo 1; else echo 0; ?>==1 )
		{
			$('.induction-5').trigger('click');
			
		}
		if(<?php if (!empty($Drug->induction_flag) && $Drug->induction_flag==1) echo 1; else echo 0; ?>==1 )
		{
			$('.induction-6').trigger('click');
			
		}
		findNearestDate();
		
		
		if('<?php if (!empty($airSide->is_required_induction) && ($airSide->is_required_induction == "1")) {
							echo 'checked';
						} ?>'=='checked'){
			$('.airside_safety').trigger('click');
			$('.expiry_airside_safety').show();
		}
		
		if('<?php if (!empty($Orientation->is_required_induction) && ($Orientation->is_required_induction == "1")) {
							echo 'checked';
						} ?>'=='checked'){
			$('.orientation').trigger('click');
			$('.expiry_orientation').show();
		}
		
		if('<?php if (!empty($Security->is_required_induction) && ($Security->is_required_induction == "1")) {
							echo 'checked';
						} ?>'=='checked'){
		...
		if('<?php if (!empty($Safe->is_required_induction) && ($Safe->is_required_induction == "1")) {
							echo 'checked';
						} ?>'=='checked'){
			$('.staying_safe').trigger('click');
			$('.expiry_staying_safe').show();
		}
		
		if('<?php if (!empty($Driving->is_required_induction) && ($Driving->is_required_induction == "1")) {
							echo 'checked';
						} ?>'=='checked'){
			$('.airside_driving').trigger('click');
			$('.expiry_airside_driving').show();
		}
		
		if('<?php if (!empty($Drug->is_required_induction) && ($Drug->is_required_induction == "1")) {
							echo 'checked';
						} ?>'=='checked'){
			$('.drug_and_alcohol').trigger('click');
			$('.expiry_drug_and_alcohol').show();
		}
	
		var companyId = <?php echo $visitor->company ?>;
