<div class="page-content">
    ...
    <div class="privacy-info">
        <h3 class="text-primary subheading-size">Airport Company Administrator Privacy Notice</h3>
        ...
        <div class="bg-gray-lighter privacy-notice" style="height:360px !important;">
            <div>
                ...
                <p class="text-size">
                    ...
                    <?=Company::model()->getCurrentTenantName() ?> may also disclose this information to third parties. For example, personal information will be shared with our Authorised Agents (as approved in our Transport Security Program) who issue VICs.<br><br><br><br>
                </p>
            </div>
