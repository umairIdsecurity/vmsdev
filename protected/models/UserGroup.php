...
class UserGroup {
    ...
    public static $USERGROUP_ARRAY_ADMINISTRATION_DASHBOARD = array(Roles::ROLE_ADMIN, Roles::ROLE_AGENT_ADMIN, Roles::ROLE_OPERATOR, Roles::ROLE_AIRPORT_OPERATOR, Roles::ROLE_AGENT_OPERATOR, Roles::ROLE_AGENT_AIRPORT_ADMIN,Roles::ROLE_ISSUING_BODY_ADMIN);
