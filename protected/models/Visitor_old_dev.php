...
class Visitor extends CActiveRecord {
    ...
    public function rules() {
        ...
        $rules = array(
            ...
            array('visitor_type', 'required', 'except' => ['updateAsic','asic', 'asicIssued', 'asicApplicant', 'corporateVisitor','importVisitor'], 'message'=>'Please complete {attribute}'),
    ...
    public function afterSave(){
        ...
        if($this->password) {
            $sql = "UPDATE ". Yii::app()->db->quoteTableName('user')." SET password = " . Yii::app()->db->quoteValue( $this->password) . " WHERE tenant=" . $this->tenant . " and email='" . $this->email . "'";
