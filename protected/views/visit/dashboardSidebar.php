...
<div id="sidebar2">
    <div class="sidebarTitle" style="">Main Menu</div><br><div id='cssmenu' class="dashboardMenu">
        <ul>
            ...
            <li class=''><a href='<?php echo Yii::app()->createUrl('dashboard/viewmyvisitors'); ?>'>
                        <span class="icons pre-visits">Pre-registered Visitors</span>
                </a></li>
            
            
            <li class=''><a href='#' ><span class="addhost">Add Host</span></a></li>

            <li class=''><a href='<?php echo Yii::app()->createUrl('visitor/create'); ?>'><span class="addvisitor">Add Visitor Record</span></a></li>
            <li class=''><a href='#'><span class="icons findrecord">Find Record</span></a></li>
