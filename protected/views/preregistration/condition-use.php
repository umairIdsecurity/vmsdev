...
<p><b>Please read conditions carefully before proceeding with application</b></p>
    ...
    <div class="privacy-info text-size">
        ...
        <ul>
			...
			<p>Note: The applicant is required under Regulation 6.41 of the ATSR 2005 to notify Airport management office in writing of conviction within 7 days if they have been convicted of an Aviation Security Related Offence (ASRO) Penalties apply for not informing Airport management office of a conviction.</p>
			</br>
			<label class="checkbox text-size" style='margin: auto; width: 60%;'>
			<?php
					echo $form->checkBox($model, 'check1',array('class'=>'checkbox'));
                ?>
				<span class=" text-size" style="line-height:21px">I certify that the above information and details are correct to the best of my knowledge.</span>
			...
			<?php
                ...
                ?>
				<span class=" text-size" style="line-height:21px">I agree to notify the Airport management office of any changes to the above particulars.</span>
    ...
    <div class="declarations" style="">
        <div class="form-group" id="privacy_notice">
			...
			<label class="checkbox text-size" style='width: 60%;'>
			<?php
					echo $form->checkBox($model, 'check3',array('class'=>'checkbox'));
                ?>
				<span class=" text-size" style="line-height:21px">I have read and agreed to the above conditions of use of all cards</span>
