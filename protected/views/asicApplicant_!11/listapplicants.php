...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'         => array(
		  ...
		  array(
                ...
                'selectableRows' => '100',
				'headerTemplate'=>'<span style="font-size:12px;">Ready To Export</span>',
                'htmlOptions'=>array('style'=>'margin-left:40px; position:absolute;')
   ...
   $(document).ready(function() {
	$('input[type="checkbox"]').on('click', function(){
			if($(this).is(':checked'))
			{
				$.ajax({
                type: 'POST',
                url: "<?php echo Yii::app()->createUrl('asicApplicant/isCompleted');?>",
                data: "id="+$(this).val(),
                success: function (data) {
                   //alert(data);
                }
			...
			else
			{
				$.ajax({
                type: 'POST',
                url: "<?php echo Yii::app()->createUrl('asicApplicant/makeIncompleted');?>",
                data: "id="+$(this).val(),
                success: function (data) {
