...
{
?>
 <a style='float: right;margin-top: -30px;' href='<?php echo 'http://vmsprtrain.identitysecurity.info/index.php/preregistration/index?tenant='.Yii::app()->user->tenant.'&em='.$model->email; ?>' target='_blank'><u> Complete Application</u> </a>
<?php 
}
?>
<div class="tab">
