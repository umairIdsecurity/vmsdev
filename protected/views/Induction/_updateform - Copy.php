							...
							<tr>
								<td>
									<div class="personal-details-section">
										...
										<div>
											<div class="identification-input asic-expiry-datepicker">
											<?php $this->widget('EDatePicker', array(
												'model'=>$visitor,
												'attribute'=>'asic_expiry',
												'mode'=>'induction_expiry',
											)); ?>
					...
					<div class="induction-records-title">
						...
						<div class = "row">
							<div class = "asic-holder">
								<?php echo $form->labelEx($airSide, 'ASIC Holder :', array('class'=>'asic-holder-title')); ?>
							</div>
						...
						<tr>
							...
							<td>
								<div class="pieces-induction">
									<div class="airside-saftey-icon-row">
										...
										<div class="airside-saftey-icon">
											<img class="airside-saftey-icon-induction" src="<?php echo Yii::app()->controller->assetsBase; ?>/images/submit-green.png" />
										</div>
									</div>
														...
														<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
																...
																<td>
																	<div style="display:inline-block;">
																		...
																		<div class="switch switch-blue">
																			...
																			<input type="radio" class="switch-input is_required_induction_radio airside_saftey" name="required_induction_airside_saftey" value="1" id="month_airside_saftey" <?php if(!empty($airSide->is_required_induction) && ($airSide->is_required_induction == "1")){echo 'checked'; }?>>
															...
															<tr class = "induction-expiry-row expiry_airside_saftey">
																<td>
																	<div class = "row">
																		<div class = "induction-required">
																			<?php echo $form->labelEx($airSide, 'induction_expiry', array('class'=>'completed-expiry-title')); ?>
																		</div>
												...
												<td>
													<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
														<tr>
															<td>
																<div style="display:inline-block;">
																	<?php echo $form->labelEx($Orientation, 'is_required_induction', array('class'=>'required-title')); ?>
																	<div class="switch switch-blue">
														...
														<tr class = "induction-expiry-row expiry_orientation">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Orientation, 'induction_expiry', array('class'=>'completed-expiry-title')); ?>
																	</div>
												...
												<td>
													<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
														<tr>
															<td>
																<div style="display:inline-block;">
																	<?php echo $form->labelEx($Security, 'is_required_induction', array('class'=>'required-title')); ?>
																	<div class="switch switch-blue">
														...
														<tr class = "induction-expiry-row expiry_security">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Security, 'induction_expiry', array('class'=>'completed-expiry-title')); ?>
																	</div>
												...
												<td>
													<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
														<tr>
															<td>
																<div style="display:inline-block;">
																	<?php echo $form->labelEx($Safe, 'is_required_induction', array('class'=>'required-title')); ?>
																	<div class="switch switch-blue">
														...
														<tr class = "induction-expiry-row expiry_staying_safe">
															<td>
																<div class = "row">
																	<div class = "induction-required">
																		<?php echo $form->labelEx($Safe, 'induction_expiry', array('class'=>'completed-expiry-title')); ?>
																	</div>
							...
							<td>
								<div class = "pieces-induction">
									<div class="airside-driving-icon-row">
										...
										<div>
											<img class="airside-driving-icon-induction" src="<?php echo Yii::app()->controller->assetsBase; ?>/images/close_icon.png" />
										</div>
									</div>
														...
														<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
															...
															<tr class = "induction-expiry-row expiry_airside_driving">
																<td>
																	<div class = "row">
																		<div class = "induction-required">
																			<?php echo $form->labelEx($Driving, 'induction_expiry', array('class'=>'completed-expiry-title')); ?>
																		</div>
							...
							<td>
								<div class = "pieces-induction">
									<div class="drug-alcohol-icon-row">
										...
										<div>
										<br />
											<img class="drug-alcohol-icon-induction" src="<?php echo Yii::app()->controller->assetsBase; ?>/images/calendar.png" />
										</div>
									</div>
														...
														<table style=" margin-top:18px !important; width:253px; border-left-style:none; border-top-style:none">
															...
															<tr class = "induction-expiry-row expiry_drug_and_alcohol">
																<td>
																	<div class = "row">
																		<div class = "induction-required">
																			<?php echo $form->labelEx($Drug, 'induction_expiry', array('class'=>'completed-expiry-title')); ?>
																		</div>
...
<script>   
	...
	if('<?php if(!empty($airSide->is_required_induction) && ($airSide->is_required_induction == "1")){echo 'checked'; }?>'=='checked')
		{
			$(".airside_saftey").trigger('click');
	...
	if($('.card-asic-icon').length==0){
		for(i=0; i<icons.length; i++){
			...
			if(icons[i].children.length==0){
				$(icons[i]).prepend("<img class='airside-saftey-icon-induction card-asic-icon' src='<?php echo Yii::app()->controller->assetsBase; ?>/images/asic-visitor-icon.png' />");							
				break;
			}
		}
...
$('.induction-1').click(function(){
	...
	if($('.induction-1').is(':checked')){
		for(i=0; i<icons.length; i++){
			//console.log(icons[i]);
			if(icons[i].children.length==0){
				$(icons[i]).prepend("<img class='airside-saftey-icon-induction airside-icon' src='<?php echo Yii::app()->controller->assetsBase; ?>/images/submit-green.png' />");							
				break;
			}
		}
	}else {
...
$('.induction-5').click(function(){
	...
	if($('.induction-5').is(':checked')){
		for(i=0; i<icons.length; i++){
			//console.log(icons[i]);
			if(icons[i].children.length==0){
				$(icons[i]).prepend("<img class='airside-saftey-icon-induction airside-driving-ada' src='<?php echo Yii::app()->controller->assetsBase; ?>/images/close_icon.png' />");							
				break;
			}
		}
	}else {
...
$('.induction-6').click(function(){
	...
	if($('.induction-6').is(':checked')){
		for(i=0; i<icons.length; i++){
			//console.log(icons[i]);
			if(icons[i].children.length==0){
				$(icons[i]).prepend("<img class='airside-saftey-icon-induction drug-alcoho' src='<?php echo Yii::app()->controller->assetsBase; ?>/images/calendar.png' />");							
				break;
			}
		}
	}else {
	...
	/*if($('.induction-6').is(':checked')){
		$('.induction-icon-3').prepend("<img class='airside-saftey-icon-induction' src='<?php echo Yii::app()->controller->assetsBase; ?>/images/calendar.png' />");							
	} else {
		console.log($('.induction-icon-3'));
		$('.induction-icon-3').empty();
	}*/
});
...
$(function(){
    ...
    onSelect: function() { 
		...
		$('#InductionRecords_1_induction_expiry_container').datepicker('setDate', dateObject);
		$('#InductionRecords_2_induction_expiry_container').datepicker('setDate', dateObject);
		$('#InductionRecords_3_induction_expiry_container').datepicker('setDate', dateObject);
		$('#InductionRecords_4_induction_expiry_container').datepicker('setDate', dateObject);
		$('#InductionRecords_5_induction_expiry_container').datepicker('setDate', dateObject);
		$('#InductionRecords_6_induction_expiry_container').datepicker('setDate', dateObject);
    }
});
});
