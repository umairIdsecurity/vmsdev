...
<div class="page-content">
    ...
    <a href="<?php echo Yii::app()->createUrl('preregistration/addAsic'); ?>"><span  class="text-size" style="color:black"><p>Please provide details of ASIC Sponsor who will be escorting the VIC holder. First, search in the box below and click Find ASIC Sponsor. If the ASIC Sponsor is not there, then Add the ASIC Sponsor details.<p>
        ...
        <div class="col-sm-4 col-xs-12" style="padding-top: 10px;">
            <?php  echo CHtml::textField('search_asic_box' , '',
                array(
                    ...
                    'placeholder'=>'Search first for ASIC Sponsor by name or email'
                )
            );
            ?>
             <?php
                    ...
                    <?php echo $form->error($model, 'last_name'); ?>
							...
							<div class="form-group">
                                ...
                                <?php $this->widget('EDatePicker', array(
                                    ...
                                    'mode'=>'date_of_birth',
                                    'htmlOptions'=>['class'=>'form-control input-sm','title'=>'Date of Birth is a unique identifier. Must be correct']
                                ));
                                ?>
