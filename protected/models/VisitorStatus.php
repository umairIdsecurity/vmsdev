...
/**
 * This is the model class for table "visitor_status".
 *
 * The followings are the available columns in table 'visitor_status':
 * @property string $id
...
class VisitorStatus extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'visitors' => array(self::HAS_MANY, 'Visitor', 'visitor_status'),
		);
	}
	 ...
	 * @return VisitorStatus the static model class
	 */
