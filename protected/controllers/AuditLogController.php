...
/*	public function accessRules()
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('AuditLog');
	...
	{
		$model=AuditLog::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AuditLog $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='audit-log-form')
		{
