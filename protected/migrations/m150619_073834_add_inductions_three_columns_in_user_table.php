...
class m150619_073834_add_inductions_three_columns_in_user_table extends CDbMigration
{
    ...
    {
        $this->dropColumn('user', 'is_required_induction','BOOLEAN NULL');
        $this->dropColumn('user', 'is_completed_induction','BOOLEAN NULL');
        $this->dropColumn('user', 'induction_expiry','DATE NULL');
    }
}