        ...
        <ul>
            ...
            <?php if ($session['role'] == Roles::ROLE_SUPERADMIN) {
                ...
                <li class='has-sub'>
                    ...
                    ?>>
                        <li><a href='<?php echo Yii::app()->createUrl('visitorType/create'); ?>'
                               class="addSubMenu"><span>Add Visitor Type</span></a></li>
                    </ul>
            ...
            <li class='has-sub'>
                ...
                ?>
                <ul <?php
                if ($this->action->id == 'vicTotalVisitCount' || $this->action->id == 'vicRegister' || $this->action->id == 'totalVicsByWorkstation' || $this->action->id == 'visitorsProfiles') {
                    echo "style='display:block ;'";
                }
                ?>>
                    ...
                    <li><a href='<?php echo Yii::app()->createUrl('avmsReports/visitorsProfiles'); ?>'><span>New Visitor Types ASIC & VIC</span></a></li>
                </ul>
            </li>
            <!-- menu for AVMS Reports -->
