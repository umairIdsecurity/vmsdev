 ...
 * @property User $user0
 */
class TenantCardType extends CActiveRecord
{
	//public $workstation;
	//public $card_type;
	/**
	...
	public function relations()
	{
		...
		return array(
			//'workstation' => array(self::BELONGS_TO, 'Workstation', 'workstation'),
	...
	public function search()
	{
		...
		$criteria->compare('tenant_id',$this->tenant,true);
		$criteria->compare('back_text',$this->back_text,true);
