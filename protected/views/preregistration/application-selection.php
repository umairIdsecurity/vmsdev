...
<!-- <div class="page-content"> -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row">
                    <div class="pull-left">
                        <h5 class="text-size text-sizeWhere">Please select one of the following</h5>
                    </div>
		...
		<img src='<?php echo Yii::app()->controller->assetsBase; ?>/images/image1.jpg'/>
		<p>Sunshine Coast Airport Management Office location map</p>
		<p><b>Contact Number:</b> 07 54531532</p>
		<p><b>Airport Address:</b> 10 Electra Lane Marcoola 4564</p>
        <div class="row"><div class="col-sm-12">&nbsp;</div></div><div class="row"><div class="col-sm-12">&nbsp;</div></div>
        <div class="row"><div class="col-sm-12">&nbsp;</div></div><div class="row"><div class="col-sm-12">&nbsp;</div></div>
