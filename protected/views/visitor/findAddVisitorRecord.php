...
<div role="tabpanel" style="width:882px">
    ...
    <input type="text" id="search-visitor" name="search-visitor" placeholder="Enter name, email, date of birth or driver licence"
...
/*            var dt = new Date();
    ...
    function backFillNewVistor(){
        ...
        $("#searchvisitor").hide();
        $('#search-visitor').val('');
        $('#search-visitor').placeholder = 'Enter name, email, date of birth or driver licence';
    }
