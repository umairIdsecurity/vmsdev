...
<div style="width:100%; float:left;">
    ...
    <div  class="box-card-style">
        ...
        <div style=" text-align:center; line-height:20px; margin:10px 0 0 5px; color:#000;height: 128px; overflow: hidden;">
            ...
            <p style="font-size:18px; font-weight:bold; line-height:18.9px; margin:0 0 3px 0;">
				<?php echo ($visitorModel->first_name != "")?substr($visitorModel->first_name, 0, 20):"N/A"; ?><br>
