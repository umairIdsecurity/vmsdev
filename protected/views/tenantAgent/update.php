                ...
                <table style="width:300px;float:left;min-height:320px;">
                    <tr>
                        ...
                        <td style="width:300px;">
                            ...
                            <input type="hidden" id="Host_photo" name="TenantForm[photo]" value="<?php echo $TenantModel->user0['photo']; ?>">
            ...
            <td style="vertical-align: top; float:left; width:300px;">
                ...
                <div class="password-border">
                    <table>
                        ...
                        <tr>
                            <td><?php echo $form->textField($model, 'tenant_agent_name', array('value'=>$TenantModel->id0['name'], 'size' => 50, 'maxlength' => 3,'placeholder'=>'Tenant Agent')); ?>
                                <span class="required">*</span>
                ...
                <div class="password-border" style="margin-top:20px;">
                    <table >
                        ...
                        <tr><td>&nbsp;</td></tr>
                        <tr>
                            <td><?php echo $form->textField($model, 'first_name', array('value'=>$TenantModel->user0['first_name'], 'size' => 50, 'maxlength' => 50,'placeholder'=>'First Name')); ?>
                                <span class="required">*</span>
                        ...
                        <tr>
                            <td><?php echo $form->textField($model, 'last_name', array('value'=>$TenantModel->user0['last_name'],'size' => 50, 'maxlength' => 50,'placeholder'=>'Last Name')); ?>
                                <span class="required">*</span>
                        ...
                        <tr>
                            <td>
                                <?php echo $form->textField($model, 'email', array('value'=>$TenantModel->user0['email'],'size' => 50, 'maxlength' => 50,'placeholder'=>'Email Address')); ?>
                                <span class="required">*</span>
                        ...
                        <tr>
                            <td><?php echo $form->textField($model, 'contact_number', array('value'=>$TenantModel->user0['contact_number'],'size' => 50, 'placeholder'=>'Contact Number')); ?>
                                <span class="required">*</span>
                ...
                <div class="password-border t-top20 paddingBottom10px">
                    ...
                    <?php if($TenantModel->user0["allowed_module"] == 3)
                            echo "CVMS & AVMS";
                        else  
                            echo User::$allowed_module[ $TenantModel->user0["allowed_module"] ];
                        ...
                        <td>
                           ...
                           <!-- <select  onchange="populateDynamicFields()"  -->  
                            <select id="User_role" name="TenantForm[role]">
                                <?php if( $TenantModel->user0->role == Roles::ROLE_AGENT_AIRPORT_ADMIN) { ?>
                            ...
                            <select id="Workstation_timezone_id" name="TenantForm[timezone_id]">
                                <?php
                                    ...
                                    foreach ($timezoneList as $key => $value) {
                                        ?>
                                        <option <?php
                                        if ($TenantModel->user0['timezone_id'] == $value['id']) {
                                            echo " selected ";
                                        } 
