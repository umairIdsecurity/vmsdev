...
//                                );
            ...
            $('.manageavmsreports').next().slideUp('normal');
                ...
                ?>
                <ul <?php
                if ($this->action->id == 'evacuationReport' || $this->action->id == 'visitorsByTypeReport' || $this->action->id == 'visitorRegistrationHistory' || $this->action->id == 'corporateTotalVisitCount') {
                    echo "style='display:block ;'";
                }
                ?>>
