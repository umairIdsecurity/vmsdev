...
<div data-ng-app="PwordForm">
    ...
    <div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <table style="float:left;width:300px;">
                        ...
                        <tr>
                            <td>
                                <?php echo $form->textField($model, 'middle_name', array('size' => 50, 'maxlength' => 50,'placeholder'=>'Middle Name')); ?><span class="required">*</span>
      ...
      <input type="text" id="Visitor_email" name="Visitor[email]" maxlength="50" size="50" placeholder="Email" value="<?php echo $model->email; ?>"/><span class="required">*</span>
                            ...
                            <td>
                                ...
                                <?php echo $form->textField($model, 'contact_number', array('size' => 50, 'maxlength' => 50,'placeholder'=>'Mobile Number')); ?><span class="required">*</span>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php echo $form->textField($model, 'contact_street_no', array('size' => 10, 'maxlength' => 50,'placeholder'=>'Street No.', 'style' => 'width: 110px;')); ?><span class="required">*</span>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php echo $form->dropDownList($model, 'contact_street_type', Visitor::$STREET_TYPES, array('empty' => 'Type', 'style' => 'width: 95px;')); ?><span class="required">*</span>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php echo $form->dropDownList($model, 'contact_state', Visitor::$AUSTRALIAN_STATES, array('empty' => 'State', 'style' => 'width: 95px;')); ?><span class="required">*</span>
                 ...
                 <table style="float:left;width:300px;">
                     ...
                     <tr>
                         <td>
                             ...
                             <label for="Visitor_alternative_identification" class="form-label">Alternative identifications<br/>One must have a signature</label>
                         </td>
