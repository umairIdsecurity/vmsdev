...
<div class="tab">
  ...
  <button class="tablinks" onclick="openEvent(event, 'operational')"><u>Operational Need & Immigration Info</u></button>
  <button class="tablinks" onclick="openEvent(event, 'identification')"><u>Name Change & Identification Info</u></button>
...
<table style="width:300px;float:left">
		...
		<?php echo $form->textField($companyName, 'name', array('maxlength' => 50,  'class'=>'form-control input-sm','disabled'=>'disabled')); ?>
		</td>
		</tr>
		<tr>
		<td>
