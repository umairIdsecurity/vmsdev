    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="image-user">
                ...
                <div class="custom-file-button" id='webcam' style="width: 220px; margin-left:-75px; margin-top:20%;">
                    <input id="startbutton" type="button">
					</div>
					<div style="width: 220px; margin-left:-75px;">
					<a href="#" style="display: block;margin-top: 35px;margin-left:150px;position: absolute;" id='retake' class="btn btn-large btn-primary btn-prev"><span class="glyphicon glyphicon-repeat"></span> Retake</a>
                <br><br>
			  ...
			  <div id='upl' class="custom-file-button2" style="width: 220px">
					...
					<br>
					<p id='upph' style="margin-left: 175px;display: block;margin-top: -10px;">Upload<p>
                </div>
            </div>
        </div>
        <div class="col-sm-4">&nbsp;</div>
