...
/**
 * @ngdoc directive
 * @name kioskApp.directive:camera
 * @description
 * Creates a custom 'camera' tag that can be placed in any view to access the camera.
 * The tag may have a 'captureCallback' attribute to use the camera output. Also,
 * a child tag ('cameraControlSnapshot') is created for the control buttons and preview
 * functionality.
 */
