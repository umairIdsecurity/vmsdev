    ...
    <div id='cssmenu'>
        <ul>
            ...
            if ($session['role'] == Roles::ROLE_ADMIN || $session['role'] == Roles::ROLE_ISSUING_BODY_ADMIN) {
                ...
                <li class='has-sub'>
                    ...
                    <a href='<?php echo Yii::app()->createUrl('tenant/edit/&id=' . $session['tenant']); ?>'><span>Organisation Settings</span></a>
                    <ul <?php
            ...
            <li class='has-sub'><a class='manageworkstations'
                ...
                ?>>
                    <li><a href='<?php echo Yii::app()->createUrl('workstation/create'); ?>' class="addSubMenu"><span <?php CHelper::is_selected_submenu('workstation', 'create');?>>Add Workstation</span></a>
                    </li>
                </ul>
            </li>
            <!-- menu for Workstations -->
        ...
        <?php } ?>
            ...
            <li class='has-sub'><a class='managevisitorrecords'
                ...
                ?>>
                    <li><a href='<?php echo Yii::app()->createUrl('visit/exportvisitorrecords', array('vms' => 'avms')); ?>'><span <?php CHelper::is_selected_submenu('visit', 'exportvisitorrecords');?>>Export Visit History</span></a>
                    </li>
                    <li><a href='<?php echo Yii::app()->createUrl('visitor/importVisitHistory', array('vms' => 'avms')); ?>'><span <?php CHelper::is_selected_submenu('visitor', 'importVisitHistory');?>>Import Visit History</span></a>
                    </li>
                    <?php if($session['role'] == Roles::ROLE_ADMIN || $session['role'] == Roles::ROLE_ISSUING_BODY_ADMIN){ ?>
                    <li>
     ...
     <?php if($module == "Both" || $module == "CVMS") {  ?>
            ...
            <li class='has-sub'>
                ...
                ?> >
                    ...
                    <li><a href='<?php echo Yii::app()->createUrl('helpDeskGroup/create'); ?>' class="addSubMenu"><span <?php CHelper::is_selected_submenu('helpDeskGroup', 'create');?>>Add Help Desk Group</span></a>
                    </li>
                    <li><a href='<?php echo Yii::app()->createUrl('helpDesk/create'); ?>' class="addSubMenu"><span <?php CHelper::is_selected_submenu('helpDesk', 'create');?>>Add Help Desk</span></a>
                    </li>
                    <li><a href='<?php echo Yii::app()->createUrl('helpDesk/admin'); ?>'><span <?php CHelper::is_selected_submenu('helpDesk', 'admin');?>>Help Desk</span></a></li>
                    <li>
                        <a href='<?php echo Yii::app()->createUrl('helpDeskGroup/admin'); ?>'><span <?php CHelper::is_selected_submenu('helpDeskGroup', 'admin');?>>Help Desk Group</span></a>
                    </li>
                </ul>
            </li>
            <!-- menu for helpdesk -->
