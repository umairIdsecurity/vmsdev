 ...
 * @property string $id
 * @property string $vehicle_registration_plate_number
 *
...
class Vehicle extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'visitors' => array(self::HAS_MANY, 'Visitor', 'vehicle'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'vehicle_registration_plate_number' => 'Vehicle Registration Plate Number',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('vehicle_registration_plate_number',$this->vehicle_registration_plate_number,true);
